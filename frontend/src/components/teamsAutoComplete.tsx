...
export default function TeamsAutoComplete(props: { setSelectedTeams: React.Dispatch<React.SetStateAction<string[]>>, disabled: boolean }) {
    const [teams, setSelectedTeams] = React.useState<string[]>([]);
